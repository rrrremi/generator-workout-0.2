      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-10 pt-4">
        ...
        >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`flex items-center gap-1.5 rounded-lg border border-white/10 ${isRefreshing ? 'bg-white/5 text-white/50' : 'bg-white/10 text-white/90 hover:bg-white/15'} px-2 py-1 text-[10px] transition-colors`}
                  >
                    <RefreshCw className={`h-3 w-3 ${isRefreshing ? 'animate-spin' : ''}`} />
                    {isRefreshing ? 'Refreshing...' : 'Refresh Users'}
                  </button>
                  
                  <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/10 px-2.5 py-1.5 text-xs">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-xl p-3">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="flex items-center justify-between p-3 border-b border-white/10">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-xs text-white/90 placeholder-white/40 backdrop-blur-xl focus:ring-1 focus:ring-white/20 focus:border-white/20"
                />
              </div>
            </div>
                        ...
                        <td className="p-2">
                          {resetEmailStatus && resetEmailStatus.email === user.email ? (
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/10 px-2 py-0.5 text-[10px] text-white/90 hover:bg-white/20 transition-colors"
                            >
